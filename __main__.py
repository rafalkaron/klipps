...
def main():
    ...
    if os.name == "nt":
        try:
            kindle_clippings_path = r"D:\documents\My Clippings.txt"
        except:
            kindle_clippings_path = r"E:\documents\My Clippings.txt"

    if os.name == "posix":
        kindle_clippings_path = r"/Volumes/Kindle/documents/My Clippings.txt"

    pb(10)
    html_str = clipps_str_to_html_str(read_file(kindle_clippings_path))
    pb(25)
    html_path = kindle_clippings_path.replace(".txt", ".html")
    pb(50)    
